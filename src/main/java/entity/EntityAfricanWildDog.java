...
public class EntityAfricanWildDog extends EntityTameable
{
    private static final DataParameter<Integer> OCELOT_VARIANT = EntityDataManager.<Integer>createKey(EntityAfricanWildDog.class, DataSerializers.VARINT);
    /** The tempt AI task for this mob, used to prevent taming while it is fleeing. */
    private EntityAITempt aiTempt;

    public EntityAfricanWildDog(World worldIn)
    {
        super(worldIn);
    ...
    public EntityAfricanWildDog createChild(EntityAgeable ageable)
    {
        EntityAfricanWildDog entityocelot = new EntityAfricanWildDog(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityAfricanWildDog))
        {
            return false;
        }
        else
        {
            EntityAfricanWildDog entityocelot = (EntityAfricanWildDog)otherAnimal;
