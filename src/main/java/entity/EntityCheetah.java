...
public class EntityCheetah extends EntityTameable
{
    ...
    public EntityCheetah createChild(EntityAgeable ageable)
    {
        EntityCheetah entityocelot = new EntityCheetah(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityCheetah))
        {
            return false;
        }
        else
        {
            EntityCheetah entityocelot = (EntityCheetah)otherAnimal;
