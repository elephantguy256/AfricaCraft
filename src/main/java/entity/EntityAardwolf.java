...
public class EntityAardwolf extends EntityTameable
{
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.<Float>createKey(EntityAardwolf.class, DataSerializers.FLOAT);
    private static final DataParameter<Boolean> BEGGING = EntityDataManager.<Boolean>createKey(EntityAardwolf.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.<Integer>createKey(EntityAardwolf.class, DataSerializers.VARINT);
    ...
    public EntityAardwolf(World worldIn)
    {
        super(worldIn);
    ...
    public EntityAardwolf createChild(EntityAgeable ageable)
    {
        EntityAardwolf entitywolf = new EntityAardwolf(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityAardwolf))
        {
            return false;
        }
        else
        {
            EntityAardwolf entitywolf = (EntityAardwolf)otherAnimal;
    ...
    public boolean shouldAttackEntity(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityAardwolf)
            {
                EntityAardwolf entitywolf = (EntityAardwolf)p_142018_1_;
