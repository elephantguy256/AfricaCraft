...
public class EntityLioness extends EntityTameable
{
    private static final DataParameter<Integer> OCELOT_VARIANT = EntityDataManager.<Integer>createKey(EntityLioness.class, DataSerializers.VARINT);
    ...
    public EntityLioness createChild(EntityAgeable ageable)
    {
        EntityLioness entityocelot = new EntityLioness(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityLioness))
        {
            return false;
        }
        else
        {
            EntityLioness entityocelot = (EntityLioness)otherAnimal;
