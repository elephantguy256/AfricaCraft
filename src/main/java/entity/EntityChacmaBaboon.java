...
public class EntityChacmaBaboon extends EntityTameable
{
    private static final DataParameter<Integer> OCELOT_VARIANT = EntityDataManager.<Integer>createKey(EntityChacmaBaboon.class, DataSerializers.VARINT);
    /** The tempt AI task for this mob, used to prevent taming while it is fleeing. */
    private EntityAITempt aiTempt;

    public EntityChacmaBaboon(World worldIn)
    {
        super(worldIn);
    ...
    public EntityChacmaBaboon createChild(EntityAgeable ageable)
    {
        EntityChacmaBaboon entityocelot = new EntityChacmaBaboon(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityChacmaBaboon))
        {
            return false;
        }
        else
        {
            EntityChacmaBaboon entityocelot = (EntityChacmaBaboon)otherAnimal;
