...
/*  77 */     this.ocelotBody.render(f5);
/*  78 */     this.ocelotFrontRightLeg.render(f5);
/*  79 */     this.ocelotBackLeftLeg.render(f5);
/*  80 */     this.ocelotTail.render(f5);
/*  81 */     this.ocelotBackRightLeg.render(f5);
/*  82 */     this.nose.render(f5);
/*  83 */     this.ear2.render(f5);
/*  84 */     this.ocelotFrontLeftLeg.render(f5);
/*  85 */     this.ear1.render(f5);
/*  86 */     GL11.glPopMatrix();
/*     */   }
/*     */   
/*     */ 
...
/* Location:              C:\Users\jhwol\Downloads\big update-deobf.jar!\com\africacraft\mob\ModelLioness.class
