...
public class EntityLion extends EntityTameable
{
    private static final DataParameter<Integer> OCELOT_VARIANT = EntityDataManager.<Integer>createKey(EntityLion.class, DataSerializers.VARINT);
    ...
    this.targetTasks.addTask(5, new EntityAINearestAttackableTarget(this, EntityAfricanElephant.class, false));
    ...
    {
        return SoundEvents2.LION;
    }

    protected SoundEvent getHurtSound()
    {
        return SoundEvents2.LIONPAIN;
    }
    ...
    public EntityLion createChild(EntityAgeable ageable)
    {
        EntityLion entityocelot = new EntityLion(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityLion))
        {
            return false;
        }
        else
        {
            EntityLion entityocelot = (EntityLion)otherAnimal;
