...
public class EntitySpottedHyena extends EntityTameable
{
    private static final DataParameter<Integer> OCELOT_VARIANT = EntityDataManager.<Integer>createKey(EntitySpottedHyena.class, DataSerializers.VARINT);
    /** The tempt AI task for this mob, used to prevent taming while it is fleeing. */
    private EntityAITempt aiTempt;

    public EntitySpottedHyena(World worldIn)
    {
        super(worldIn);
    ...
    public EntitySpottedHyena createChild(EntityAgeable ageable)
    {
        EntitySpottedHyena entityocelot = new EntitySpottedHyena(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntitySpottedHyena))
        {
            return false;
        }
        else
        {
            EntitySpottedHyena entityocelot = (EntitySpottedHyena)otherAnimal;
