...
public class EntityBrownHyena extends EntityTameable
{
    private static final DataParameter<Integer> OCELOT_VARIANT = EntityDataManager.<Integer>createKey(EntityBrownHyena.class, DataSerializers.VARINT);
    /** The tempt AI task for this mob, used to prevent taming while it is fleeing. */
    private EntityAITempt aiTempt;

    public EntityBrownHyena(World worldIn)
    {
        super(worldIn);
    ...
    public EntityBrownHyena createChild(EntityAgeable ageable)
    {
        EntityBrownHyena entityocelot = new EntityBrownHyena(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityBrownHyena))
        {
            return false;
        }
        else
        {
            EntityBrownHyena entityocelot = (EntityBrownHyena)otherAnimal;
